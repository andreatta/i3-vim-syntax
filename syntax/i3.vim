...
syn match i3ColorDef3 "client\.\(focused_inactive\|focused\|unfocused\|urgent\|placeholder\)\|inactive_workspace\|urgent_workspace\|focused_workspace\|active_workspace" nextgroup=i3Color1st skipwhite
